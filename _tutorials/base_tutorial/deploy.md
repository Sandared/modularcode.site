...
![Application bndrun](img/deploy-bndrun-0.png)
...
![Application bndrun](img/deploy-bndrun-1.png)

At the right top of the `bndrun`'s `Run` tab there are a number of buttons:

![Application bndrun](img/deploy-bndrun-2.png)
...
![Application bndrun](img/deploy-debug-0.png)
...
![Application bndrun](img/deploy-debug-1.png)
