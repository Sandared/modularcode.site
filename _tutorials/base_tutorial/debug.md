...
![Debugging](img/debug-debug-0.png)
...
![Debugging](img/debug-debug-1.png)
...
![Class patching dialog](img/debug-debug-2.png)
...
![Run Window for adding XRay](img/debug-xray-0.png)
...
![XRay](img/debug-component-0.png)
...
![XRay](img/debug-config-0.png)

If you click on an entry then such an editor opens:

![XRay](img/debug-config-1.png)
