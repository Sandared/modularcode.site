...
![Create Application Project](img/app-create-0.png)
...
![Create Application Project](img/app-create-1.png)
...
![The UpperApplication source code](img/upper-0.png)
...
![Resolved set](img/resolve-initial-2.png)
...
![Resolved set](img/run-buttons-0.png)
...
![Resolved set](img/debug-patch-0.png)
...
![Resolved set](img/debug-details-0.png)
...
Password:	admin
```
![Resolved set](img/debug-xray-0.png)
...
![Run buttons](img/run-buttons-0.png)
